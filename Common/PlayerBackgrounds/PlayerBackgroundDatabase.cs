...
namespace NewBeginnings.Common.PlayerBackgrounds
{
    internal static class PlayerBackgroundDatabase
    {
        ...
        private static void LoadAllBackgrounds()
        {
            ...
            AddNewBG("Beastmaster", "Beastmaster", "Raised in the woodlands, they summon beasts to aid their journey.", "Lower max health but an immediate slime staff and leather whip.", new MiscData(60, sortPriority: 11, stars: 2), (ItemID.SlimeStaff, 1), (ItemID.BlandWhip, 1));
