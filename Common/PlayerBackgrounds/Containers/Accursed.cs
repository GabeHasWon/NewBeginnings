...
internal class Accursed : PlayerBackgroundContainer
{
    ...
    public override MiscData Misc => new(sword: ItemID.GoldBroadsword, pick: ItemID.GoldPickaxe, axe: ItemID.GoldAxe, npcType: NPCID.Dryad, stars: 5);

    public override bool ClearCondition() => UnlockSaveData.Unlocked("Accursed");

    public override void ModifyWorldGenTasks(List<GenPass> list) => list.Add(new PassLegacy("Early Hardmode", (GenerationProgress p, Terraria.IO.GameConfiguration config) =>
    {
