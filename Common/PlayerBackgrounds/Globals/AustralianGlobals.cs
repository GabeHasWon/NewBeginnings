...
internal class AustralianPlayer : ModPlayer
{
    ...
    public override void Load() => On_LegacyPlayerRenderer.DrawPlayerFull += LegacyPlayerRenderer_DrawPlayerFull;

    private static void LegacyPlayerRenderer_DrawPlayerFull(On_LegacyPlayerRenderer.orig_DrawPlayerFull orig, LegacyPlayerRenderer self, Camera camera, Terraria.Player drawPlayer)
    {
